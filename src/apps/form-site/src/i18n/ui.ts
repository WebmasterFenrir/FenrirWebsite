...
const nl = {
  ...
  'successText': 'Je antwoord is veilig binnengekomen. Bedankt voor je hulp!',
  'successSummaryTitle': 'Jouw antwoorden',
...
const en: Ui = {
  ...
  'successText': 'Your response has been safely received. Thanks for your help!',
  'successSummaryTitle': 'Your answers',
